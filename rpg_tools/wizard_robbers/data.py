SKILLS = [
    ...
    {
        # Fast-Talk
        "Cajolery": "Convince another through charisma or subterfuge.",
    },
    {
    ...
    {
        # Muscle
        "Puissance": "Break down doors, lift heavy things, etc.",
    },
    {
        # Parkour / Acrobatics
        "Funambulism": "Balancing, climbing, jumping, tumbling.",
    },
    {
    ...
    {
        # Zoophilism / Animal Handling
        "Zoopathy": "Ability to calm, empathize with, and communicate in a "
